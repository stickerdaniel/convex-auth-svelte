...
import { AnyDataModel, GenericActionCtx, GenericDataModel, GenericMutationCtx } from "convex/server";
...
export interface EmailConfig<DataModel extends GenericDataModel = GenericDataModel> extends AuthjsEmailConfig {
     ...
     */
    params: Record<string, Value | undefined>, account: GenericDoc<DataModel, "authAccounts">) => Promise<void>;
}
/**
