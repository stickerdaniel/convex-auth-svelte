 ...
 * ```
 */
export declare function setupConvexAuth({ client, storage, storageNamespace, replaceURL, convexUrl, options, }: {
     ...
     */
    relativeUrl: string) => void | Promise<void>;
    /**
